    ...
    return (
        <div id='skills' className=' px-5 py-10 mt-10 flex flex-col gap-y-10'>
            ...
            <div className="flex text-white flex-row gap-6 gap-y-10 md:gap-5 flex-wrap justify-center md:justify-start w-full">
                ...
                <div className="w-[155px] md:w-40  gap-y-7 flex flex-col items-center justify-center p-10 h-60 border-[#565656] border-[1px] rounded-full translateUp" ref={(el) => { if (el) elementsRef.current.push(el); }}>
                    <i className='fa-brands fa-html5 text-3xl text-[60px]'></i>
                    <span className='text-sm'>HTML</span>
                </div>
                <div className="w-[155px] md:w-40 gap-y-7 flex flex-col items-center justify-center p-10 h-60 border-[#565656] border-[1px] rounded-full translateDown" ref={(el) => { if (el) elementsRef.current.push(el); }} >
                    <i className='fa-brands fa-css3 text-3xl text-[60px]'></i>
                    <span className='text-sm'>CSS</span>
                </div>
                <div className="w-[155px] md:w-40  gap-y-7 flex flex-col items-center justify-center p-10 h-60 border-[#565656] border-[1px] rounded-full translateRight" ref={(el) => { if (el) elementsRef.current.push(el); }}>
