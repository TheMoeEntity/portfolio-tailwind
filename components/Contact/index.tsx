...
const Contact = () => {
  ...
  const submitForm = async (e: FormEvent<HTMLFormElement>) => {
    ...
    await emailjs
      ...
      .then(() => {
        toast.success(
          "Your message has been sent successfully. I would get back to you as soon as possible"
        );
      })
      .catch(() => {
        toast.error(
    ...
    >
      ...
      <div>
        ...
        >
          ...
          <div className="mt-5">
            <button className="rounded-full bg-[#0053cc] text-white px-12 py-4">
              SEND MESSAGE
            </button>
          </div>
          {loading && (
            <div
              className={
                "items-center justify-center " + (true ? "flex" : "hidden")
              }
            >
