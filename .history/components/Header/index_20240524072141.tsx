        ...
        <div className='flex absolute flex-row justify-end items-center py-5 md:px-20 px-2 w-full'>
            ...
            <div className={`fixed text-sm top-0 z-[55] right-0 w-[80%] md:w-[60%] lg:w-[30%] bg-[#191919] h-full py-10 gap-y-16 px-10 duration-500 transition-transform flex flex-col justify-center items-center ${sidebar ? 'translate-x-0' : 'translate-x-[100%]'}`}>
                ...
                <div className="flex justify-center items-center text-gray-400">
                    <button><i className="fas fa-house mr-2 w-2 h-2"></i> Home</button>
                </div>
                <div className="flex justify-center items-center text-gray-400">
                    <button><i className="fas fa-user mr-2 w-2 h-2"></i> About</button>
                </div>
                <div className="flex justify-center items-center text-gray-400">
                    <button><i className="fas fa-file-alt mr-2 w-2 h-2"></i>Resume</button>
                </div>
                <div className="flex justify-center items-center text-gray-400">
                    <button><i className="fas fa-briefcase mr-2 w-2 h-2"></i>Portfolio</button>
                </div>
                <div className="flex justify-center items-center text-gray-400">
                    <button><i className="fas fa-cogs mr-2 w-2 h-2"></i>Services</button>
                </div>
                <div className="flex justify-center items-center text-gray-400">
                    <button><i className="fas fa-envelope mr-2 w-2 h-2"></i>Contact</button>
                </div>
            </div>
        </div>
    )
