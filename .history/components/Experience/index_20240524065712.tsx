        ...
        <div ref={introRef} id='experience' className=' px-5 py-10 mt-10 flex flex-col gap-y-10'>
            ...
            <div>
                <div className='flex flex-row gap-x-12'>
                    ...
                    <div ref={(el) => { if (el) elementsRef.current.push(el); }} className='reveal group'>
                        <div className='text-xl hover:group-'>2017-2022</div>
                        <div className='flex flex-col gap-y-4 mt-5'>
                            <h2 className='font-semiboold text-2xl md:text-3xl text-white'>Junior Web Developer</h2>
                            <h3>ZZDIGITAL</h3>
                        </div>
                        <div className='flex flex-col gap-y-4 mt-5'>
                            <h2 className='font-semiboold text-2xl md:text-3xl text-white'>Junior IOS Mobile Developer</h2>
                            <h3>ZZDIGITAL</h3>
                        </div>
                    </div>
                </div>
